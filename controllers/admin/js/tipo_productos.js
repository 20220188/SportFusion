        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-info" onclick="openUpdate(${row.id_tipo_producto})">
                        <i class="lni lni-pencil"></i>
                        </button>
                        <button type="button" class="btn btn-danger" onclick="openDelete(${row.id_tipo_producto})">
