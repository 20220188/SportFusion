...
class PedidoHandler
{
    ...
    */
    ...
    {
        $sql = 'SELECT dp.id_detalle, dp.cantidad_pedido, dp.precio_pedido, t.pedido, g.producto, p.estado_pedido
    ...
    {
        $sql = 'SELECT id_detalle, cantidad_pedido, precio_pedido, id_pedido, id_producto, id_estado_pedido
                FROM tb_detalle
